...
export class SettingsStore {
  constructor(filePath) {
    ...
    this.underfilledTeamWarnings = {};
    this.teamNicknameOwners = {};
    this.playerKits = {};
    this.deletedTeams = {};
    this.protectedMentions = {};
    this.teamEditorRoles = {};
  ...
  async load() {
    try {
      ...
      this.underfilledTeamWarnings = value.underfilledTeamWarnings && typeof value.underfilledTeamWarnings === "object" ? value.underfilledTeamWarnings : {};
      ...
      this.teamEditorRoles = value.teamEditorRoles && typeof value.teamEditorRoles === "object" ? value.teamEditorRoles : {};
    } catch (error) {
  ...
  async save() {
    this.saveQueue = this.saveQueue.catch(() => {}).then(async () => {
      ...
      if (!Object.keys(value.teamEditorRoles).length) delete value.teamEditorRoles;
